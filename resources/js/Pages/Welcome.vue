...
<template>
  <Head title="Welcome" />
  <div class=" px-8 py-6 lg:px-20 lg:py-10">
    <div
      class="relative lg:flex lg:items-center lg:justify-between"
    >
      ...
      <div
        v-if="isMenuOpen"
        class="flex flex-col lg:flex-row mt-10 lg:mt-0 gap-5 lg:gap-8"
      >
        <Link
          :href="route('login')"
    ...
    <div class="flex items-center flex-wrap lg:flex-nowrap gap-10 py-16 lg:py-28">
    ...
    <div>
      <h1 class="text-center text-3xl font-bold ">Latest Blogs</h1>
