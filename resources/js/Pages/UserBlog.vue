      ...
      <div v-if="blogs.length == 0" class="flex justify-center bg-white">
        <div class="p-8">
          ...
          <div class="flex justify-center">
            <a
              :href="route('posts')"
              class="inline-flex items-center  gap-3 text-white bg-orange-500 px-4 py-2 rounded-lg"
            >
              Create Blog
              <svg
        ...
        <div class="flex justify-between flex-wrap gap-8 mt-10 py-8 px-6">
          ...
          <div class="flex items-start gap-2 ms-auto">
            <a
              ...
              class="px-4 py-3 rounded-lg text-blue-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
            ...
            <button
              ...
              class="px-4 py-3 rounded-lg text-red-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
